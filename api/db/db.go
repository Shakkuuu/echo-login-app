...
func autoMigration() {
	...
	db.AutoMigrate(entity.HasItemList{}).AddForeignKey("user_id", "users(id)", "CASCADE", "CASCADE")
	db.AutoMigrate(entity.Status{}).AddForeignKey("user_id", "users(id)", "CASCADE", "CASCADE")
}
